...
\033[1;94m ┈┈┈▕▕K4 P4▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕K4 P4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94kashipathan.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93kashipathan\033[1;91m...............

\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : K4_KASHI_P4_PATHAN

\033[1;92m☞ WhatsApp   : 03100918597

\033[1;95m☞ YouTube    : https://youtube.com/channel/UCfdb6TPZYofbc9dLNuTmbqQ
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://youtube.com/channel/UCfdb6TPZYofbc9dLNuTmbqQ)
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update K4_KASHI Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' P4_PATHAN WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/P4_PATHAN')

	    os.system('cd $HOME && git clone https://github.com/kashipathan/kashi')
	    ...
	    psb('WhatsApp Num 03100918597✓')

	    psb('WellCome To P4_PATHAN')

	    psb('Congratulations P

K4_KASHI Tool Has Been Updated Successfully')

	    psb('🔓User Name☆Malang✓')

	    psb('🔓Password ☆Malang✓')

	    psb('Subscrib My Youtube Channel BLACK444 ✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/P4_PATHAN && python2 P4.py')
